...
var __cosbahost =  "http://localhost/cosba/";

$("head").append('<script type="text/javascript" src="' + __cosbahost + 'public/js/jquery-ui.js"></script>');
$("head").append('<script type="text/javascript" src="' + __cosbahost + 'public/js/jquery.dataTables.min.js"></script>');
$("head").append('<script type="text/javascript" src="' + __cosbahost + 'public/js/codebase/webix.js"></script>');
