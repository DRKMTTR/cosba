        ...
        <table class="dataTable" id="eleveTable">
            ...
            <tbody>
                ...
                foreach ($notes as $note) {
                    ...
                    echo "<tr><td>" . $note['MATRICULE'] . "<input type='hidden' name='id_".$ideleve."' value='".$note['IDNOTE']."' /></td>";
                    echo "<td>" . $note['NOM'] . " " . $note['PRENOM'] . "</td>";
                    echo "<td align='center'><input style=\"text-align: right\" onKeyUp = \"noter('" . $ideleve . "');\" "
                            . "type = 'text' name = 'note_" . $ideleve . "' size = '2' value = '" . $note['NOTE'] . "' /></td>";
                    if ($note['ABSENT'] === 1) {
                    ...
                    echo "<td align='center'><input type='text' name = 'observation_" .$ideleve. "' value='".$note['OBSERVATION'] . "'  "
                            . "size = '30' /></td></tr>";
                }
                ?>
            </tbody>
